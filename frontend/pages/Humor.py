...
from utils.graficos import liquid_fill, barras_empilhadas_horizontais, grefico_calendario
...
humor = df_filtrado.reset_index()[['Data', 'Humor']].dropna(subset=['Humor'])
humor = humor.rename(columns={'Humor': 'value'})
